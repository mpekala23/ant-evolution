...
to setup-queens
  ...
  ask queens [
    set gen-point (list random 100 random 100 random 100)
  ]
  ask queens [
    ...
    set color rgb (item 0 gen-point * 1.4) (item 1 gen-point * 1.4) (item 2 gen-point * 1.4)
    ...
    while [i < scent-id-count][
      ...
      let other-gen [gen-point] of partner
        set dist-list insert-item i dist-list gen-dist gen-point other-gen][set dist-list insert-item i dist-list -1]
...
to-report gen-dist [me them]


  let dist-temp (abs (item 0 me - item 0 them) + abs (item 1 me - item 1 them) + abs (item 2 me - item 2 them))
  report dist-temp
end
...
to start-fight [others]
  ...
  [
    ...
    [
      ...
      let i-fight random 100 < gen-diff / 3 * fight-mult
      ifelse i-fight
      [
        ;; Both ants fight
        if not ive-died [
...
to split-colony
  ...
  hatch-queens 1 [
    ...
    ;;
    set color rgb (item 0 gen-point) (item 1 gen-point) (item 2 gen-point)
    set dist-list (list )
    let i 0
    while [i < scent-id-count][
